                ...
                if (
                  ...
                  if (asset.hash) {
                    ...
                    try {
                      ...
                      if (distributor[2]) {
                        let body = `Please Deliver to the given address: ${props.consumerAdd} \n Thanks & Regards \n 
                        Group-2`;
                        const options = {
                          method: "POST",
                          ...
                          headers: {
                            ...
                            "X-RapidAPI-Key":
                              "e030741dffmsh4a176c28613be49p1e205cjsnc253bb10e0d1",
                          },
                          data: `{"personalizations":[{"to":[{"email":"${distributor[2]}"}],"subject":"Dispatch Item"}],"from":{"email":"varshneyprateek20@gmail.com"},"content":[{"type":"text/plain","value":"${body}"}]}`,
                        };
                        axios
                          .request(options)
